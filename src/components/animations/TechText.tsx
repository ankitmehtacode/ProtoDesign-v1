/*
 * TechText by David Haz, from React Bits (https://reactbits.dev/text-animations/tech-text).
 * Copyright (c) 2026 David Haz. MIT + Commons Clause License Condition v1.0:
 * used here as part of this website; the component itself is not sold or redistributed.
 * Vendored unmodified from src/ts-tailwind/TextAnimations/TechText/TechText.tsx.
 */
